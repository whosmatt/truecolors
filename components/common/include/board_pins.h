...
// ---------------------------------------------------------------------------
// Laser enables, active-high to the LM3409 EN/PWM input.
...
// Analog sense on ADC1. ADC2 is unusable while Wi-Fi is active.
...
// ---------------------------------------------------------------------------
// MCPWM: one group, one timer, three operators.
